<template>
  <div v-bind:id="'widget_' + pId" class="widget widget_table-coach" ref="widget">
  ...
  methods:{
    ...
    cell:function( _col, _row ){
      ...
      if( _data.candidates_data[_col].buzzer_count > 0 ){
        var coachIndex = _data.coaches_keys.indexOf( _data.candidates_data[_col].coach_name )
        cellColor = _this.svgSettings.customPalette[ coachIndex ];
      }
